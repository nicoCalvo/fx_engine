...
class TestMarketOrder(unittest.TestCase):
    KEYS_REPR = ['order_id', 'limit_price', 'amount',
                 'stop_price', 'order_type', 'symbol']
    ...
    def test_valid_amount(self):
        ...
        amount = 200
        order_number = 0
        market_order = MarketOrder(symbol, amount, order_number)
        self.assertTrue(market_order.is_valid(portfolio))
