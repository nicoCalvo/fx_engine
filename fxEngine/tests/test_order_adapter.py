...
class MockDataPortal(mock.Mock):
	...
	current_tick = [{"ask": 7.44185, "bid": 7.44135, "medium": 7.4416, "symbol": "EURDKK", "time": "2010/01/04 00:00:00"}, {"ask": 1.44146, "bid": 1.44126, "medium": 1.44136, "symbol": "USDEUR", "time": "2010/01/04 00:00:00"}]
...
class TestOrderAdapter(unittest.TestCase):
	new_orders = [{"order_type": "LimitOrder", "order_id": "MHw1MDM=","amount": 3, "stop_price": 0.0,
				  ...
				  "stop_price": 0.0,"limit_price":555}]
	def setUp(self):
		pass
