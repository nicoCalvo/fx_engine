...
scheduler_test = {"id": "9", "end_date": "2016-10-06", "capital_base": 9999999, "simulation_type": "backtest", "frequency": "daily", "pairs_list": ["USDEUR", "ARSMEX"], "start_date": "2015-10-03",
                  "script": "from atakama_api.dates import Dates\n\n\n\n\ndef initialize(context):\n    context.i = 4\n    context.days = 0\n    context.months = 0\n\n\ndef handle_data(context, data):\n    pass\n\n\ndef before_new_day(context, data):\n    context.days += 1\n\ndef before_new_month(context, data):\n    context.months += 1"}

scheduler_plus_simpleai_test = {"id": "9", "end_date": "2016-10-06", "capital_base": 9999999, "simulation_type": "backtest", "frequency": "daily", "pairs_list": ["USDEUR", "ARSMEX"], "start_date": "2015-10-03",
